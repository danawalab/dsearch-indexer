...
1. master 브랜치의 src/main/java 하위 모든 자바파일을 server-lib 브랜치에 매뉴얼로 붙혀넣어 관리합니다.

2. server-lib 브랜치는 절대 application.yml 안에 내용을 입력하면 안됩니다.
   특정 설정이 parent 프로세스에 영향이 될 수 있습니다.
